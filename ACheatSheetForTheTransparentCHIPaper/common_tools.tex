  ...
  \begin{columns}[t]\hfill\hfill\hfill
    \begin{column}{.45\linewidth}
      \begin{subblock}{\faIcon{folder} \hfill Data and File Organization\hfill \faIcon{folder-open}}
        \begin{itemize}
          \item Research Data Alliance \href{rd-alliance.org/}{rd-alliance.org/}
        \end{itemize}
      ...
      \begin{subblock}{\faDatabase \hfill Data Repositories \hfill \faDatabase}
        \begin{itemize}
          \item \textbf{Open Science Framework (\href{OSF.io}{OSF.io})}
          \item Zenodo (\href{zenodo.org}{zenodo.org})
          \item Harvard Dataverse (\href{dataverse.harvard.edu}{dataverse.harvard.edu})
    %  \item ICPSR
    %  \item Dryad
    %  \item Figshare
    %  \item Vivli
      ...
      \begin{subblock}{\faIcon{table} \hfill Paper Repositories \hfill \faIcon{table}}
        \begin{itemize}
          \item \textbf{Open Science Framework (\href{OSF.io}{OSF.io})}
          \item arXiv (\href{arxiv.org}{arxiv.org})
        \end{itemize}
      \vskip-1ex
      \end{subblock}  
...
%      \end{subblock}  
      ...
      \begin{itemize}
        \item \faIcon{github} GitHub (\href{github.com}{github.com})
        %\item Open Science Framework (OSF)
        \item Zenodo (\href{zenodo.org}{zenodo.org})
        \item \faIcon{gitlab} GitLab (\href{gitlab.com}{gitlab.com})
        \item \faIcon{bitbucket} Bitbucket (\href{bitbucket.org}{bitbucket.org})
      \end{itemize}
    \end{subblock}
